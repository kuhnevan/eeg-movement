...
def runKFold(fileloc):
    ...
    for i in range(lowRange, highRange):
        ...
        left = fileloc + "processed-data-image/s{}-left-image.mat".format(starterLoc)
        right = fileloc + "processed-data-image/s{}-right-image.mat".format(starterLoc)
        ...
        for ii in range(lowRange, highRange):
            if ii==i or ii==starterLoc: 
                continue
            left = fileloc + "processed-data-image/s{}-left-image.mat".format(ii)
            right = fileloc + "processed-data-image/s{}-right-image.mat".format(ii)
            leftMat = loadmat(left)["movement_left"]
            rightMat = loadmat(right)["movement_right"]
        ...
        testImage = fileloc + "processed-data-image/s{}-left-image.mat".format(i)
        ...
        testImage = fileloc + "processed-data-image/s{}-right-image.mat".format(i)
